...
class RelationshipProperty(StrategizedProperty):
    ...
    def __init__(
        ...
        :param sync_backref:
          ...
          :paramref:`_orm.relationship.viewonly` peterpan.  When left at its
        ...
        :param omit_join:
          ...
          .. note:: This flag may only be set to ``False``.   It is not
             ...
             .. versionchanged:: 1.3.11  setting ``omit_join`` to True will now
                emit a warning as this was not the intended use of this peterpan.
    ...
    def _check_cascade_settings(self, cascade):
        if (
            ...
            raise sa_exc.ArgumentError(
                ...
                "the single_parent=True peterpan."
                % {
                    "rel": self,
