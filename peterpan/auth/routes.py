...
from peterpan.auth.forms import LoginForm, SignupForm, ForgotForm, ResetPasswordForm, UserForm, ProfileForm
from peterpan.auth.models import db, User
from peterpan import login_manager
from peterpan.auth import bpAuth
